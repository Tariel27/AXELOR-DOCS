...
2. [Загрузка и установка Axelor](#Загрузка-и-установка-Axelor)
3. [Конфигурация сервера приложений (для Tomcat)](#Конфигурация-сервера-приложений (для Tomcat))
...
## Конфигурация сервера приложений (если используется Tomcat)
