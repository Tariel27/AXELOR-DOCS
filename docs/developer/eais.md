...
4. [Интеграция с ЕАИС - Создания класса сервиса](#4-интеграция-с-еаис---создания-класса-сервиса)
5. [Интеграция с ЕАИС - Создания маппера](#5-интеграция-с-еаис---создания-маппера)
6. [Интеграция с ЕАИС - Создания контроллера](#6-интеграция-с-еaис---создания-контроллера)
7. [Интеграция с ЕАИС - Обновление существующей декларации](#7-интеграция-с-еaис---обновление-существующей-декларации)
8. [Интеграция с ЕАИС - Обновление существующей декларации - Сервис для сравнение новой декларации со старой](#8-интеграция-с-еaис---обновление-существующей-декларации---сервис-для-сравнение-новой-декларации-со-старой)
    * 8.1 [Метод **dataCheckingProducts:](#метод-datacheckingproducts)
    * 8.2
10. [Базовые операции CRUD](#9-базовые-операции-crud)
...
### 4. Интеграция с ЕАИС - Создания класса сервиса
***
...
### 5. Интеграция с ЕАИС - Создания маппера
***
...
### 6. Интеграция с ЕАИС - Создания контроллера
***
...
### 8. Интеграция с ЕАИС - Обновление существующей декларации - Сервис для сравнение новой декларации со старой
