...
4. [Интеграция с ЕАИС: Создание класса сервиса](#4-интеграция-с-еaис-создание-класса-сервиса)
5. [Интеграция с ЕАИС: Создание маппера](#5-интеграция-с-еaис-создание-маппера)
